...
const validator = require('validator');
 ...
 const tourSchema =  new mongoose.Schema({
            ...
            slug: String, //addedd in document middlWar
            duration:{
                 type:Number,
                 required:[true,'A tour must  have a deuration']
            },
            maxGroupSize:{
                 type:Number,
            ...
            price:{
              ...
              priceDiscount : {// val-->dis price
                   type:Number,
                   validate :{ // coustom validator
